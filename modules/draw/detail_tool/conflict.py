...
class ToolDetail(Base):
  ...
  def create(self, context):
    ...
    '''INTEGRATION TO XPATTERN PLUGIN'''
    ...
    for o in objects:
      if (o.fp_id != ob.fp_id):
        if (self.find_element_in_list(o.fp_id, self.USEDPOINTS) == None):
          if ((Vector((round(o.end1[0], 4), round(o.end1[1], 4), 0.0)) == Vector(
            (round(point[0], 4), round(point[1], 4), 0.0))) or (
            Vector((round(o.end2[0], 4), round(o.end2[1], 4), 0.0)) == Vector(
            (round(point[0], 4), round(point[1], 4), 0.0)))):
  ...
  def make_line_new_type(self, obj, point1, point2, type):
    ...
    if (type == 'line'):
      ...
      if (point1.hr != point1.pos):
        point1.hl = Vector((1 * math.cos(math.radians(90.0 + point1.fp_angles[0])) + x1,
                            1 * math.sin(math.radians(90.0 + point1.fp_angles[0])) + y1, 0))
        point2.hr = Vector((1 * math.cos(math.radians(-90.0 + point2.fp_angles[1])) + x2,
                            1 * math.sin(math.radians(-90.0 + point2.fp_angles[1])) + y2, 0))
      else:
        point1.hr = Vector((1 * math.cos(math.radians(90.0 + point1.fp_angles[0])) + x1,
                            1 * math.sin(math.radians(90.0 + point1.fp_angles[0])) + y1, 0))
        point2.hl = Vector((1 * math.cos(math.radians(-90.0 + point2.fp_angles[1])) + x2,
                            1 * math.sin(math.radians(-90.0 + point2.fp_angles[1])) + y2, 0))
    if (type == 'curve'):
      if (point1.hr != point1.pos):
