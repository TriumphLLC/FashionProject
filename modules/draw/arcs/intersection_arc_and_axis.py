...
class IntersectionArcAndAxis(Base):
        FP_TYPE = 'fp.draw.points.intersection_arc_and_axis'
        DEFAULT_LOCATION = (0.0, 0.0, 0.0)
        BASE_NAME = 'ТочкаПересеченияДугиОси'
        POINT_RADIUS = 0.075
        ...
        def create(self, context):
                ...
                obj.show_name = True
                obj.select = False
                mat = bpy.data.materials.new('ЗаливкаТочкиПересеченияДугиОси')
